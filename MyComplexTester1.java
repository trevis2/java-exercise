...
public class MyComplexTester1
{
   ...
   { 
        ...
        MyComplex1 a = new MyComplex1(aRe, aIm);
        ...
        MyComplex1 b = new MyComplex1(bRe, bIm);


        // test dei metodi di MyComplex1 e stampe a standard output
